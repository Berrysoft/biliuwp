    ...
    public class ToView : IModules
    {
        ...
        public async Task<ReturnModel<ObservableCollection<ToViewsModel>>> GetToViewList()
        {
            try
            {
                ...
                string url = string.Format("https://api.bilibili.com/x/v2/history/toview/web?access_key={0}&appkey={1}&ts={2}", ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, ApiHelper.TimeStamp);
        ...
        public async Task<ReturnModel> AddToView(string aid)
        {
            try
            {
                ...
                string par = string.Format("aid={3}&access_key={0}&appkey={1}&ts={2}", ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, ApiHelper.TimeStamp, aid);
        ...
        public async Task<ReturnModel> ClearToView()
        {
            try
            {
                ...
                string par = string.Format("access_key={0}&appkey={1}&ts={2}", ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, ApiHelper.TimeStamp);
                par += "&sign=" + ApiHelper.GetSign(par);
        ...
        public async Task<ReturnModel> ClearPlayed()
        {
            try
            {
                ...
                string url = "https://api.bilibili.com/x/v2/history/toview/del";
                string par = string.Format("access_key={0}&appkey={1}&ts={2}&viewed=true", ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, ApiHelper.TimeStamp);
                par += "&sign=" + ApiHelper.GetSign(par);
