    ...
    public sealed partial class MusicSearchPage : Page
    {
        ...
        private async void SearchSongs()
        {
            try
            {
                ...
                url = string.Format(url, ApiHelper.AndroidKey.Appkey, Uri.EscapeDataString(_keyword), _pageSongs, ApiHelper.TimeStamp);
        ...
        private async void SearchMenus()
        {
            try
            {
                ...
                url = string.Format(url, ApiHelper.AndroidKey.Appkey, Uri.EscapeDataString(_keyword), _pageMenus, ApiHelper.TimeStamp);
                url += "&sign=" + ApiHelper.GetSign(url);
        ...
        private async void SearchUsers()
        {
            try
            {
                ...
                url = string.Format(url, ApiHelper.AndroidKey.Appkey, Uri.EscapeDataString(_keyword), _pageUsers, ApiHelper.TimeStamp);
                url += "&sign=" + ApiHelper.GetSign(url);
