    ...
    public sealed partial class MusicianPage : Page
    {
        ...
        private async void LoadUpInfo()
        {
            try
            {
                ...
                url = string.Format(url, ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey,ApiHelper.GetUserId(),ApiHelper.TimeStamp,_mid);
        ...
        private async Task<List<MusicHomeSongModel>> GetSongs()
        {
            try
            {
                ...
                url = string.Format(url, ApiHelper.AndroidKey.Appkey, _mid,ApiHelper.TimeStamp);
                url += "&sign=" + ApiHelper.GetSign(url);
            ...
            if (ApiHelper.IsLogin())
            {
                try
                {
                    ...
                    string content = string.Format(
                        ...
                        ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, _mid, ApiHelper.TimeStamp2
                        );
