    ...
    public sealed partial class LiveMyMedalPage : Page
    {
        ...
        private async void Cancel()
        {
            ...
            try
            {
                ...
                string url = $"http://live.bilibili.com/AppUser/canelMedal?access_key={ApiHelper.AccessKey}&appkey={ApiHelper.AndroidKey.Appkey}&build={ApiHelper.build}&mobi_app=android&platform=android";
                url += "&sign=" + ApiHelper.GetSign(url);
                string results = await WebClientClass.GetResults(new Uri(url));
        ...
        private async void Add(int id)
        {
            try
            {
                ...
                string url = $"http://live.bilibili.com/AppUser/wearMedal?access_key={ApiHelper.AccessKey}&appkey={ApiHelper.AndroidKey.Appkey}&build={ApiHelper.build}&platform=android";
                url += "&sign=" + ApiHelper.GetSign(url);
