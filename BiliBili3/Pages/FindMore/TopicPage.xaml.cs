    ...
    public sealed partial class TopicPage : Page
    {
        ...
        private async void GetTopic()
        {
            try
            {
                ...
                string url = string.Format("http://api.bilibili.com/topic/getlist?access_key={0}&appkey={1}&build=424000&mobi_app=android&page={2}&pagesize=20&platform=android&ts={3}", ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, page, ApiHelper.TimeStamp);
