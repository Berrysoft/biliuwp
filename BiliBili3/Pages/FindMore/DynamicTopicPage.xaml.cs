    ...
    public sealed partial class DynamicTopicPage : Page
    {
        ...
        private async void GetDynamic()
        {
            try
            {
                ...
                tag, ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, ApiHelper.TimeStamp2);
               ...
               tag, ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, ApiHelper.TimeStamp2, ls_dynamic.GetLastDynamicId());
                }
