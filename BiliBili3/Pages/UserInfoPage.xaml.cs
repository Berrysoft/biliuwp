    ...
    public sealed partial class UserInfoPage : Page
    {
            ...
            if (ApiHelper.IsLogin())
            {
                try
                {
                    ...
                    string content = string.Format(
                        ...
                        ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, Uid, ApiHelper.TimeStamp2
                        );
        ...
        private async void GetDynamic()
        {
            try
            {
                ...
                ApiHelper.AccessKey, ApiHelper.AndroidKey.Appkey, Uid, next, ApiHelper.TimeStamp2, ApiHelper.GetUserId());
                url += "&sign=" + ApiHelper.GetSign(url);
